...
Version `0.2.108` is the current 10th Edition milestone release: all in-scope 10th Edition factions now have engine and support-matrix coverage. Active development is now focused on 11th-edition-first port prep while preserving the existing 10th Edition engine baseline.
