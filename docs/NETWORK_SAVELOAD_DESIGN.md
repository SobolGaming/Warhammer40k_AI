...
- heroic_intervention_mode_dialog: SELECT_HEROIC_INTERVENTION_MODE {stratagem_name, mode_id, cp_delta, charge_target_policy, max_roll_cap?} (context `stratagem_modes[]`, `selection_kind="heroic_intervention_mode"`, `source_unit_id`, `target_unit_id`, `preview_gated`, `dispatch_mode="interrupt"`, `interrupt_window="after_enemy_charge_move"`)
