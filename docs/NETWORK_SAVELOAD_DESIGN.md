...
- quarry_selection_dialog: PICK_OBJECTIVE {objective_id} (context `ability="a_grim_warning"` | `ability="corrupting_taint"` | `ability="corrupt_realspace"` | `ability="no_retreat"`)
