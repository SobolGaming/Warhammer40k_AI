...
def _enhancement_support(name: str, enh_id: str, description: str) -> Tuple[str, str]:
    explicit = {
        ...
        "000010694002": "Weaponised Hatred: after selecting your Vendetta target in your Command phase, select a second enemy unit; if your Vendetta target is destroyed before your next Command phase, the second unit automatically becomes your Vendetta target until a new target is selected.",
