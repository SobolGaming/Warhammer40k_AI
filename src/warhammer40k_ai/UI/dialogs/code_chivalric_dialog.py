...
class CodeChivalricDialog(BaseDialog):
    """Modal dialog to select a Code Chivalric Deed or Quality."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=580, height=430, draggable=True)
        self.title = "Code Chivalric"
        self.header = ""
        ...
        self.add_button("confirm", (self.width - 160) // 2, self.height - 50, 160, 36)

    def show(self, *, title: str, header: str, on_confirm: Callable[[str], None], decision_request=None):
        super().show()
        self.visible = True
        self.title = title or "Code Chivalric"
    ...
    def draw(self, screen: pygame.Surface):
        ...
        header = self.font_small.render(self.header, True, TEXT_SECONDARY)
