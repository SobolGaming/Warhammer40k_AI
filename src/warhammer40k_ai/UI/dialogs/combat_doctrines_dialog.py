...
class CombatDoctrinesDialog(BaseDialog):
    """Modal dialog to select a Combat Doctrine at the start of a Command phase."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=560, height=380, draggable=True)
        self.title = "Combat Doctrines"
