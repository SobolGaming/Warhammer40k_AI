...
class CombatDrugsDialog(BaseDialog):
    """Modal dialog to select Combat Drugs at command phase start."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=620, height=470, draggable=True)
        self.title = "Combat Drugs"
    ...
    def draw(self, screen: pygame.Surface):
        ...
        header = self.font_small.render("Select a Combat Drug or roll 2D6:", True, TEXT_SECONDARY)
        ...
        for i, entry in enumerate(self._option_entries):
            ...
            name = entry.get("label", "Combat Drug")
