...
class DarkPactsDialog(BaseDialog):
    """Modal dialog to select a Dark Pact choice when a unit is selected to shoot or fight."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=520, height=360, draggable=True)
        self.title = "Dark Pacts"
        self.subtitle = ""
    ...
    def show(
        ...
        *,
        ...
        super().show()
        self.visible = True
        self.title = title or "Dark Pacts"
