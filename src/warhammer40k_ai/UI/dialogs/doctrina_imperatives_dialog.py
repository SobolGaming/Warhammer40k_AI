...
class DoctrinaImperativesDialog(BaseDialog):
    """Modal dialog to select a Doctrina Imperative at battle round start."""
    ...
    def draw(self, screen: pygame.Surface):
        ...
        header = self.font_small.render("Choose one Imperative for this battle round:", True, TEXT_SECONDARY)
