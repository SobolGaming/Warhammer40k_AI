...
class HarbingersOfDreadDialog(BaseDialog):
    """Modal dialog to select a Harbingers of Dread option at battle round start."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=580, height=440, draggable=True)
        self.title = "Harbingers of Dread"
    ...
    def draw(self, screen: pygame.Surface):
        ...
        header = self.font_small.render("Choose one Dread ability or roll 2D6:", True, TEXT_SECONDARY)
        ...
        for i, entry in enumerate(self._option_entries):
            ...
            name = entry.get("label", "Harbinger")
