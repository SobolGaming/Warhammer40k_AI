...
class HazardObjectiveSelectDialog(BaseDialog):
    """Small modal dialog to select a Hazard objective marker to move."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=520, height=360, draggable=True)
        self.title = "Select Hazard Objective"
        self.game_view = None
        self.choices = []
    ...
    def draw(self, screen: pygame.Surface):
        ...
        # Header
        header = self.font_small.render("Choose which Hazard objective marker this unit will move:", True, TEXT_SECONDARY)
