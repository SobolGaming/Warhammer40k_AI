...
class IdolsOfKhorneDialog(BaseDialog):
    """Modal dialog to select an Idol of Khorne at the start of a Command phase."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=560, height=420, draggable=True)
        self.title = "Idols of Khorne"
    ...
    def draw(self, screen: pygame.Surface):
        ...
        header = self.font_small.render("Select one Idol (once per battle each) or None:", True, TEXT_SECONDARY)
