...
class ShadowFormDialog(BaseDialog):
    """Modal dialog to select a Shadow Form at the start of each battle round."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=600, height=440, draggable=True)
        self.title = "Shadow Form"
    ...
    def draw(self, screen: pygame.Surface):
        ...
        for i, opt in enumerate(self.options):
            ...
            name = getattr(opt, "name", "Shadow Form")
