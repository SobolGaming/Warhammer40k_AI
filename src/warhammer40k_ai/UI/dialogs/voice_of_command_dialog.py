...
class VoiceOfCommandDialog(BaseDialog):
    """Modal dialog to select an Order for Voice of Command."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=600, height=440, draggable=True)
        self.title = "Voice of Command"
    ...
    def draw(self, screen: pygame.Surface):
        ...
        header = self.font_small.render("Choose an Order to issue:", True, TEXT_SECONDARY)
