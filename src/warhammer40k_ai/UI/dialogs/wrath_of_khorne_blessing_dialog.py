...
class WrathOfKhorneBlessingDialog(BaseDialog):
    """Modal dialog to select a bonus Blessing of Khorne for Vessels of Wrath."""

    def __init__(self, screen_width: int, screen_height: int):
        super().__init__(screen_width, screen_height, width=560, height=400, draggable=True)
        self.title = "Wrath of Khorne"
    ...
    def draw(self, screen: pygame.Surface):
        ...
        header = self.font_small.render("Select a Blessing for Vessels of Wrath:", True, TEXT_SECONDARY)
