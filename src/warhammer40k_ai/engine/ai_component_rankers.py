        ...
        "deployment_ranker": _weights(
            {
                ...
                "commander_deployment_alignment": 2.0,
                "deployment_sequence_priority": 1.4,
                "preferred_drop_window_score": 0.7,
                "scout_lane_value": 1.2,
                "scout_cover_after_move_score": 1.0,
                "scout_objective_threat_score": 1.1,
                "infiltrate_screen_value": 1.3,
                "counter_scout_value": 1.2,
                "enemy_forward_deny_value": 0.9,
                "go_first_value": 0.45,
                "go_second_safety": 1.0,
                "first_turn_uncertainty_risk": -1.3,
                "deployment_reveal_risk": -0.6,
                "deployment_replan_stale_penalty": 1.0,
                "fixed_secondary_lane_score": 0.5,
                "tactical_secondary_flexibility_score": 0.6,
            },
        ),
        "movement_ranker": _weights(
            {
                ...
                "commander_transport_alignment": 2.0,
                "commander_transport_intent_satisfied": 0.8,
                "commander_transport_match_satisfied": 0.4,
                "commander_transport_destination_satisfied": 0.7,
                "commander_embark_intent_satisfied": 0.8,
                "commander_disembark_intent_satisfied": 0.8,
                "commander_transport_action_violation": -3.0,
                "commander_transport_plan_stale_penalty": -0.6,
            },
        ),
        ...
        "charge_ranker": _weights(
            {
                ...
                "commander_charge_alignment": 2.2,
                "commander_charge_primary_target_selected": 1.0,
                "commander_charge_backup_target_selected": 0.45,
                "commander_charge_multi_target_penalty": -0.8,
                "commander_charge_probability": 0.8,
                "commander_charge_plan_stale_penalty": -0.8,
            },
        ),
        "fight_ranker": _weights(
            {
                ...
                METADATA_RESOURCE_DELTA: 0.3,
                "commander_fight_alignment": 2.1,
                "commander_fight_primary_target_selected": 1.0,
                "commander_fight_backup_target_selected": 0.4,
                "commander_fight_multi_target_penalty": -0.7,
                "commander_fight_activation_priority": 0.15,
                "commander_fight_plan_stale_penalty": -0.8,
            },
        ),
