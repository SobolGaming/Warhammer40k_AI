...
_ORKS_TEMP_BUFF_STRATAGEM_DESCRIPTORS: dict[str, StratagemToolDescriptor] = {
    ...
    "000010800004": StratagemToolDescriptor(
        stratagem_id="000010800004",
        name="RUN 'EM DOWN",
        timing="movement_phase",
        target="battlewagon_kill_rig_or_hunta_rig_unit_not_yet_moved_and_up_to_two_nearby_orks_vehicle_or_monster_units",
        duration="until_end_of_turn",
        effect="source_and_selected_units_charge_after_advance",
        cp_cost=1,
        range_in=6.0,
        effect_params={
            "source_names_any": ["Battlewagon", "Kill Rig", "Hunta Rig"],
            "source_requires_not_selected_to_move": True,
            "other_required_keywords_any": ["VEHICLE", "MONSTER"],
            "other_required_faction_keyword": "ORKS",
            "max_other_units": 2,
            "selected_units_within_inches": 6,
            "charge_after_advance": True,
        },
    ),
