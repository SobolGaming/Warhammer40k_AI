...
from warhammer40k_ai.engine.decision_kinds import DECISION_CONFIRM_YES_NO, DECISION_REQUEST_DICE_ROLL
...
def test_tier1_plan_is_not_attached_to_dice_policy_context() -> None:
    game, p1, _p2 = _build_game()
    request = DecisionRequest.create(
        DECISION_REQUEST_DICE_ROLL,
        "Roll",
        player_id=p1.id,
        context={"compute_tier": "invalid"},
    )
