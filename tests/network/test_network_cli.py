...
def test_network_cli_parses_client_headless_mode() -> None:
    ...
    assert args.llm_agent_config == ""


def test_network_cli_parses_headless_llm_agent_config() -> None:
    parser = _build_parser()
    args = parser.parse_args(
        [
            "client-headless",
            ...
            "player2",
            "--llm-agent-config",
            "data/llm_agent_config.json",
        ]
    )
    assert args.llm_agent_config == "data/llm_agent_config.json"
