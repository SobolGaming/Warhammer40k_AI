...
def test_champions_of_fenris_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000009851002": "Wolves' Wisdom",
        "000009851003": "Foes' Fate",
        "000009851004": "Fangrune Pendant",
        "000009851005": "Longstrider",
    }
