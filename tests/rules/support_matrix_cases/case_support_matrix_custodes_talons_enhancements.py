...
def test_custodes_talons_of_the_emperor_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000008921002": "Aegis Projector",
        "000008921003": "Champion of the Imperium",
        "000008921004": "Gift of Terran Artifice",
        "000008921005": "Radiant Mantle",
    }
