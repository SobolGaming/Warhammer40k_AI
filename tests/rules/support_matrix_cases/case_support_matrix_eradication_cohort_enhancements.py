...
def test_eradication_cohort_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010747002": "Belicosa-Class Capacitor Vanes",
        "000010747003": "Martial Signatum Amplificator",
        "000010747004": "Omnicogitator",
        "000010747005": "Omnissiah's Fury",
    }
