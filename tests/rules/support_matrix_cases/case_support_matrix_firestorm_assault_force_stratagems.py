...
def test_firestorm_assault_force_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000008483003": "closest eligible target within 6",
        "000008483004": "end of the fight phase",
        "000008483005": "torrent ranged weapons",
        "000008483006": "battle-shock",
        "000008483007": "reactively disembark",
    }
