...
def test_forgefathers_seekers_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010369003": "closest eligible target within 6",
        "000010369004": "shoot after falling back",
        "000010369005": "torrent ranged weapons",
        "000010369006": "reactively disembark",
        "000010369007": "charge rolls this phase",
    }
