...
def test_genestealer_cults_biosanctic_broodsurge_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000009076002": "relocate one threatened marker",
        "000009076003": "2d3",
        "000009076004": "monster and vehicle",
        "000009076005": 'pile in and consolidate up to 6"',
        "000009076006": "closest eligible enemy",
        "000009076007": "leadership test at -1",
    }
