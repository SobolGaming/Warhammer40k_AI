...
def test_genestealer_cults_brood_brother_auxilia_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000009085007": "normal move of up to 6",
        "000009085005": "d3+1 mortal wounds",
        "000009085002": 'wholly within 6"',
        "000009085003": "identical replacement unit",
        "000009085006": "re-roll wound rolls of 1",
    }
