...
def test_godhammer_assault_force_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010401002": "normal move up to 6",
        "000010401003": "wholly within 6",
        "000010401004": "move horizontally through terrain",
        "000010401005": "move through models during its charge move",
        "000010401006": "re-rolling 1s normally or the full wound roll if it disembarked from a land raider",
    }
