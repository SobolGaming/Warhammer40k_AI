...
def test_hammer_of_avernii_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010624004": "sticky",
        "000010624003": "below starting strength",
        "000010624006": "reduces incoming melee damage by 1",
        "000010624005": "lethal hits",
        "000010624007": "strategic reserves",
    }
