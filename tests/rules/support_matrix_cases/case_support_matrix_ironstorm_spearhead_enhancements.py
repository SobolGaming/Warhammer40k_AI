...
def test_ironstorm_spearhead_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000008478002": "Target Augury Web",
        "000008478003": "The Flesh is Weak",
        "000008478004": "Adept of the Omnissiah",
        "000008478005": "Master of Machine War",
    }
