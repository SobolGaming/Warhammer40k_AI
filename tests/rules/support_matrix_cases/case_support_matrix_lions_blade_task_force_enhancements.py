...
def test_lions_blade_task_force_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000009733002": "Calibanite Armaments",
        "000009733003": "Lord of the Hunt",
        "000009733004": "Stalwart Champion",
        "000009733005": "Fulgus Magna",
    }
