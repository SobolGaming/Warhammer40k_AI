...
def test_realspace_raiders_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010574002": "Dark Vitality",
        "000010574003": "Labyrinthine Cunning",
        "000010574004": "Eye of Spite",
        "000010574005": "Crucible of Malediction",
    }
