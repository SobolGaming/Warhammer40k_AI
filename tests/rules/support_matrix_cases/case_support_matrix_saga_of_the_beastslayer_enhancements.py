...
def test_saga_of_the_beastslayer_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010269002": "Wolf-touched",
        "000010269003": "Hunter's Guile",
        "000010269004": "Elder's Guidance",
        "000010269005": "Helm of the Beastslayer",
    }
