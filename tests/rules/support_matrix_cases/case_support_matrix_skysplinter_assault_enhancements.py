...
def test_skysplinter_assault_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010576002": "Phantasmal Smoke",
        "000010576003": "Sadistic Fulcrum",
        "000010576004": "Spiteful Raider",
        "000010576005": "Nightmare Shroud",
    }
