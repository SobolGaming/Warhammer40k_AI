...
def test_armoured_speartip_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010779002": "Liberator",
        "000010779003": "Tip of the Spear",
        "000010779004": "Shock Deployment",
        "000010779005": "Armoured Commander",
    }
