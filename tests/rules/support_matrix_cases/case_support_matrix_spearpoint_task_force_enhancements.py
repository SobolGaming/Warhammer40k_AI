...
def test_spearpoint_task_force_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010629002": "Spearpoint Paragon",
        "000010629003": "Stormseers' Wisdom",
        "000010629004": "Hunter's Eye",
        "000010629005": "Chogorian Huntmaster",
    }
