...
def test_spirit_conclave_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000009907002": "Light of Clarity",
        "000009907003": "Stave of Kurnous",
        "000009907004": "Rune of Mists",
        "000009907005": "Higher Duty",
    }
