...
def test_stormlance_task_force_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000008487003": "sustained hits 1",
        "000008487004": "fixed advance distance 9",
        "000008487005": "re-roll charge rolls",
        "000008487006": "-1 to hit and -1 to wound",
        "000008487007": 'normal move of up to 6"',
    }
