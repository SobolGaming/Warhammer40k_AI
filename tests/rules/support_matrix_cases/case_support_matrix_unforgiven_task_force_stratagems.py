...
def test_unforgiven_task_force_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000008389005": "ignores cover",
        "000008389006": "reactive shooting",
        "000008389004": "shoot and charge after falling back",
        "000008389007": "-1 to wound",
        "000008389003": "critical hits on 5+",
    }
