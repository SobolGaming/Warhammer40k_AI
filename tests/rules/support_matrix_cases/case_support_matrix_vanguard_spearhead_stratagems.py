...
def test_vanguard_spearhead_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000008491002": "sabotaged",
        "000008491006": "reactive normal move",
        "000008491007": "strategic reserves",
        "000008491005": "battle-shock",
        "000008491004": "precision",
    }
