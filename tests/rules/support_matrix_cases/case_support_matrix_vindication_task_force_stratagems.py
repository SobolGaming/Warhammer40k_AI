...
def test_vindication_task_force_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010397002": "full wounds",
        "000010397003": "improves ap",
        "000010397004": "ignores cover",
        "000010397005": "+1 to the hit roll",
        "000010397007": "out-of-turn charge",
    }
