...
def test_wrathful_procession_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000009844004": "gains [precision]",
        "000009844005": "re-rolls hit rolls of 1",
        "000009844006": "fight eligibility out to 3",
        "000009844007": "unit-specific override",
    }
