...
class TestDetachmentSupportClassification(unittest.TestCase):
    ...
    def test_rapid_drop_deployment_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Rapid-drop Deployment")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("orbital assault force", notes.lower())

    def test_oath_of_reclamation_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Oath of Reclamation")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("reclamation force", notes.lower())

    def test_purge_and_sanctify_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Purge and Sanctify")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("vindication task force", notes.lower())

    def test_zealous_litanies_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Zealous Litanies")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("wrathful procession", notes.lower())
    ...
    def test_murderous_imperative_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Murderous Imperative")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("eradication cohort", notes.lower())
    ...
    def test_heroes_all_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Heroes All")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("saga of the bold", notes.lower())
    ...
    def test_legendary_slayers_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Legendary Slayers")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("beastslayer", notes.lower())

    def test_psychic_disciplines_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Psychic Disciplines")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("librarius conclave", notes.lower())
    ...
    def test_knightly_teachings_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Knightly Teachings")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("spearhead", notes.lower())

    def test_dauntless_defenders_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Dauntless Defenders")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("gate warden lance", notes.lower())

    def test_cogbound_alliance_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Cogbound Alliance")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
    ...
    def test_cyber_psalm_programming_is_supported(self):
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("cohort cybernetica", notes.lower())

    def test_benedictions_of_the_omnissiah_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Benedictions Of The Omnissiah")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("data-psalm conclave", notes.lower())

    def test_acquisition_at_any_cost_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Acquisition At Any Cost")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("explorator maniple", notes.lower())

    def test_noospheric_transference_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Noospheric Transference")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
    ...
    def test_marks_of_chaos_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Marks of Chaos")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("pactbound zealots", notes.lower())

    def test_stitchflesh_abominations_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Stitchflesh Abominations")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("covenite coterie", notes.lower())

    def test_murderous_agenda_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Murderous Agenda")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("kabalite cartel", notes.lower())

    def test_alliance_of_agony_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Alliance of Agony")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("realspace raiders", notes.lower())

    def test_callous_competition_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Callous Competition")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("reaper", notes.lower())

    def test_rain_of_cruelty_is_supported(self):
        gsm, detachment_abilities = self._seed_support_maps()
        row = next(r for r in detachment_abilities if str(r.get("name", "") or "") == "Rain Of Cruelty")
        status, notes = gsm._classify_ability(
            row.get("name", ""),
            row.get("description", ""),
            ability_id=row.get("id", ""),
        ...
        self.assertEqual(status, "Supported")
        self.assertIn("skysplinter", notes.lower())
