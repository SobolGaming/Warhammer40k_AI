...
class TestNecronsDatasheetGroup3Abilities(unittest.TestCase):
    ...
    def test_canoptek_swarm_queues_target_and_bodyguard_return(self):
        ...
        army_one = Army.with_detachment("A1", detachment_type="Test")
        army_two = Army.with_detachment("A2", detachment_type="Test")
    ...
    def test_eternity_gate_allows_hyperphased_reserve_unit_on_battle_round_one(self):
        ...
        battlefield = Battlefield(BattlefieldSize.STRIKE_FORCE)
        game = Game(battlefield)
        army_one = Army.with_detachment("A1", detachment_type="Hypercrypt Legion")
        army_two = Army.with_detachment("A2", detachment_type="Test")
        player_one = Player("P1", control=PlayerControl.LOCAL, army=army_one)
        player_two = Player("P2", control=PlayerControl.REMOTE, army=army_two)
        game.add_player(player_one)
