...
def test_blade_of_ultramar_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010634004": "lance",
        "000010634006": "ignores cover",
        "000010634007": "normal move of up to d6",
        "000010634003": "-1 to wound",
        "000010634005": "army-wide doctrine",
    }
