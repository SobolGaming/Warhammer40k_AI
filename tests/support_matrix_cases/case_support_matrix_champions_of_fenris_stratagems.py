...
def test_champions_of_fenris_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000009852005": "battle-shock test",
        "000009852007": "strategic reserves",
        "000009852002": "lethal hits",
        "000009852004": "sticky",
        "000009852006": "stealth",
    }
