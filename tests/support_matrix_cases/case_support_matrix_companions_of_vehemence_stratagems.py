...
def test_companions_of_vehemence_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010393002": "piles in",
        "000010393007": "battle-shock",
        "000010393004": "precision",
        "000010393003": "consolidate",
        "000010393006": "reactive move",
        "000010393005": "re-roll",
    }
