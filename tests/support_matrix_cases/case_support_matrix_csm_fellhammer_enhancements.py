...
def test_csm_fellhammer_siege_host_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000008976002": "Bastion Plate",
        "000008976003": "Iron Artifice",
        "000008976004": "Ironbound Enmity",
        "000008976005": "Warp Tracer",
    }
