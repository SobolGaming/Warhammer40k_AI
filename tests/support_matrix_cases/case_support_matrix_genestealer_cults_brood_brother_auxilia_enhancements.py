...
def test_genestealer_cults_brood_brother_auxilia_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000009084002": "Martial Espionage",
        "000009084004": "The Hero Returned",
        "000009084005": "Firepoint Commander",
    }
