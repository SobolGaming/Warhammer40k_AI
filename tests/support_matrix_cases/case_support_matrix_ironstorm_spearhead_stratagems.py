...
def test_ironstorm_spearhead_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000008479006": "objective control",
        "000008479004": "below starting strength",
        "000008479007": "below half-strength",
        "000008479002": "saving throws",
        "000008479005": "deadly demise",
    }
