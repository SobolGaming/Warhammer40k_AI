...
def test_orbital_assault_force_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010681002": "suppressed",
        "000010681003": "character unit",
        "000010681004": '6"',
        "000010681005": "lethal hits",
        "000010681006": "benefit of cover",
        "000010681007": "embark",
    }
