...
def test_reclamation_force_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010685002": "objective control",
        "000010685003": "once per turn",
        "000010685004": "fights on death",
        "000010685005": "falling back",
        "000010685006": "remain under your control",
        "000010685007": 'd6"+1',
    }
