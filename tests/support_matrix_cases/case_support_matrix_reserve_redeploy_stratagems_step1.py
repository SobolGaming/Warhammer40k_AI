...
def test_reserve_redeploy_step1_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000009038007": "jump pack unit",
        "000010365006": "command phase",
        "000010365007": "within 12",
        "000008443007": "stealth",
    }
