...
def test_saga_of_the_great_wolf_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010661003": "hunting pack override",
        "000010661004": "through models and terrain",
        "000010661005": "charge after falling back",
        "000010661006": "+1 to wound",
        "000010661007": "reactive normal move",
    }
