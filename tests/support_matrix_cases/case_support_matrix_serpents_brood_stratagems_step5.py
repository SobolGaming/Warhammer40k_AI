...
def test_serpents_brood_step5_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010650004": "eligible to declare a charge in a turn in which it advanced",
        "000010650006": "normal move up to 6",
    }
