...
def test_shadowmark_talon_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010467003": "precision",
        "000010467004": "falling back",
        "000010467005": "battle-shock",
        "000010467006": "reactive normal move",
        "000010467007": "strategic reserves",
    }
