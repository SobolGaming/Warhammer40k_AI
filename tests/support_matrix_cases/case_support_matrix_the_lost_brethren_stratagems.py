...
def test_the_lost_brethren_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000009187004": "fights on death",
        "000009187005": "pile-in",
        "000009187002": "objective remains sticky",
        "000009187006": "hazardous",
        "000009187007": "charge after advancing",
    }
