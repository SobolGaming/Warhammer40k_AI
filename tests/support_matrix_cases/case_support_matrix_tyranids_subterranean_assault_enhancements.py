...
def test_tyranids_subterranean_assault_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010147002": "Synaptic Strategy",
        "000010147003": "Tremor Senses",
        "000010147004": "Vanguard Intellect",
        "000010147005": "Trygon Prime",
    }
