...
def test_companions_of_vehemence_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010392002": "Incendiary Animus",
        "000010392003": "Oathbound Exemplar",
        "000010392004": "Merciless Denunciation",
        "000010392005": "Zealous Vanguard",
    }
