...
def test_company_of_hunters_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000008778002": "Master-crafted Weapon",
        "000008778003": "Mounted Strategist",
        "000008778004": "Master of Manoeuvre",
        "000008778005": "Recon Hunter",
    }
