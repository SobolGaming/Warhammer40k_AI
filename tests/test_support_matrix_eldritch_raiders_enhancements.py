...
def test_eldritch_raiders_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010699002": "Pirate Prince",
        "000010699003": "Alacritous Assault",
        "000010699004": "Exotic Munitions",
        "000010699005": "Adrenal Infusions",
    }
