...
def test_godhammer_assault_force_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010400002": "Paragon of Fury",
        "000010400003": "Battle-psalm Precentor",
        "000010400004": "Augury Servo-host",
        "000010400005": "Herald of Sacred Slaughter",
    }
