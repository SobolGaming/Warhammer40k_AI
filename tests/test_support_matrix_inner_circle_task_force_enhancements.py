...
def test_inner_circle_task_force_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000008774002": "Champion of the Deathwing",
        "000008774003": "Eye of the Unseen",
        "000008774004": "Singular Will",
        "000008774005": "Deathwing Assault",
    }
