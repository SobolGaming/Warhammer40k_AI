...
def test_liberator_assault_group_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000008376002": "Speed of the Primarch",
        "000008376003": "Rage-fuelled Warrior",
        "000008376004": "Icon of the Angel",
        "000008376005": "Gift of Foresight",
    }
