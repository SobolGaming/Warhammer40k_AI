...
def test_orbital_assault_force_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010680002": "Laurels of Thunder",
        "000010680003": "Veteran of the Vanguard",
        "000010680004": "Orbital Uplink Reliquary",
        "000010680005": "Dedicated Gunship",
    }
