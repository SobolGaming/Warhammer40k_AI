...
def test_serpents_brood_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000010649002": "Key of Ghosts",
        "000010649003": "Weavers' Wail",
        "000010649004": "Fanged Leer",
        "000010649005": "Shedskin Raiment",
    }
