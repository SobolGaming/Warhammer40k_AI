...
def test_serpents_brood_step4_stratagems_are_implemented():
    import scripts.generate_ability_support_matrix as gsm

    stratagems = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Stratagems.json"))
    expected = {
        "000010650002": "all three dance of death",
        "000010650005": "fall back move of up to 6",
        "000010650007": "strategic reserves",
    }
