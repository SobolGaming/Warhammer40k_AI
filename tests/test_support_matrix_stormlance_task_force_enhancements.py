...
def test_stormlance_task_force_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000008486002": "Fury of the Storm",
        "000008486003": "Portents of Wisdom",
        "000008486004": "Feinting Withdrawal",
        "000008486005": "Hunter's Instincts",
    }
