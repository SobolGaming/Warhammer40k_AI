...
def test_the_angelic_host_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000009190002": "Artisan of War",
        "000009190003": "Visage of Death",
        "000009190004": "Archangel's Shard",
        "000009190005": "Gleaming Pinions",
    }
