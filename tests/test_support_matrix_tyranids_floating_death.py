...
CASES = [
    ("Floating Death", "Spore Mines"),
    ("Floating Death", "Mucolid Spores"),
]
...
@pytest.mark.parametrize(("ability_name", "unit_name"), CASES)
def test_support_matrix_tyranids_floating_death_supported(ability_name: str, unit_name: str):
    import scripts.generate_ability_support_matrix as gsm

    _seed_maps(gsm)
    row = _find_tyranids_datasheet_ability_row(gsm, ability_name=ability_name, unit_name=unit_name)
