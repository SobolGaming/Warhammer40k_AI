...
CASES = [
    ("Singular Purpose", "Norn Assimilator"),
    ("Singular Purpose", "Norn Emissary"),
]
...
def test_support_matrix_tyranids_singular_purpose_supported(ability_name: str, unit_name: str):
