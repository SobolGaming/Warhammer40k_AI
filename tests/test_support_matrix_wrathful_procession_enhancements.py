...
def test_wrathful_procession_enhancements_are_supported():
    import scripts.generate_ability_support_matrix as gsm

    enhancements = gsm._read_json(os.path.join(gsm.WAHA_DIR, "Enhancements.json"))
    expected = {
        "000009843002": "Pyrebrand",
        "000009843003": "Sacred Rage",
        "000009843004": "Taramond's Censer",
        "000009843005": "Benediction of Fury",
    }
